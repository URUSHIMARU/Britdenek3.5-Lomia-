...
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=1}] as @e[tag=boss11_lomia,tag=body] at @s run teleport @s ~ ~ ~ facing entity @e[tag=boss11_lomiabattle,limit=1,sort=nearest,distance=..20]
...
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=12..20}] as @e[tag=body2,limit=1,tag=boss11_lomia] at @s run teleport @s ~ ~ ~ ~ ~-1
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=12..20}] as @e[tag=left_arm,limit=1,tag=boss11_lomia] at @s run teleport @s ~ ~ ~ ~-5 ~-14
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=12..20}] as @e[tag=right_arm,limit=1,tag=boss11_lomia] at @s run teleport @s ~ ~ ~ ~5 ~-14


execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34..35}] as @e[tag=left_arm,limit=1,tag=boss11_lomia] at @s run teleport @s ~ ~ ~ ~10 ~50
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34..35}] as @e[tag=right_arm,limit=1,tag=boss11_lomia] at @s run teleport @s ~ ~ ~ ~-10 ~50
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34..35}] as @e[tag=left_arm,limit=1,tag=boss11_lomia] at @s run particle minecraft:sweep_attack ^ ^ ^3 1.5 1.5 1.5 1 100 force
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34..35}] as @e[tag=right_arm,limit=1,tag=boss11_lomia] at @s run particle minecraft:sweep_attack ^ ^ ^3 1.5 1.5 1.5 1 100 force
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34}] as @e[tag=left_arm,limit=1,tag=boss11_lomia] at @s run playsound minecraft:entity.player.attack.sweep master @a ~ ~ ~ 2 0.6
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34}] as @e[tag=right_arm,limit=1,tag=boss11_lomia] at @s run playsound minecraft:entity.player.attack.sweep master @a ~ ~ ~ 2 0.6
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34..35}] as @e[tag=left_arm,tag=boss11_lomia,limit=1] at @s positioned ^ ^ ^3 as @e[tag=boss11_lomiabattle,distance=..6] unless score @s player = @e[tag=boss11_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 9
execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=34..35}] as @e[tag=right_arm,tag=boss11_lomia,limit=1] at @s positioned ^ ^ ^3 as @e[tag=boss11_lomiabattle,distance=..6] unless score @s player = @e[tag=boss11_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 9

execute if entity @e[tag=boss11_lomia,tag=body,scores={motion=12}] as @e[tag=head,limit=1,tag=boss11_lomia] at @s run playsound minecraft:entity.polar_bear.warning master @a ~ ~ ~ 2 0.8
