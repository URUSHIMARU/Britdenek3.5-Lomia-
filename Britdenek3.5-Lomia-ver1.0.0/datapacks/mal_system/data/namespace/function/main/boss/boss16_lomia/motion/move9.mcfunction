...
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=1..2}] as @e[tag=boss16_lomia,tag=body] at @s run teleport @e[tag=body,limit=1,tag=boss16_lomia] ~ ~0 ~ facing entity @e[tag=!bullet,tag=boss16_lomiabattle,limit=1]
...
execute as @e[tag=boss16_lomia,tag=body,limit=1,scores={motion=10}] at @s run playsound minecraft:entity.horse.jump master @a ~ ~ ~ 2 1.1
execute as @e[tag=boss16_lomia,tag=body,limit=1,scores={motion=10}] at @s run particle minecraft:sweep_attack ~ ~0.5 ~ 1 1 1 1 40 force
execute as @e[tag=boss16_lomia,tag=body,limit=1,scores={motion=10..16}] at @s if block ^-2 ^0.5 ^ #namespace:airs_for_mob run teleport @s ^-0.8 ^ ^
execute as @e[tag=boss16_lomia,tag=body,limit=1,scores={motion=10..13}] at @s run teleport @s ^ ^0.8 ^
execute as @e[tag=boss16_lomia,tag=body,limit=1,scores={motion=13..16}] at @s run teleport @s ^ ^-0.8 ^


execute as @e[tag=boss16_lomia,tag=body,scores={motion=20..},limit=1] at @s run function namespace:main/boss/boss16_lomia/motion/random2

execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=20..},limit=1] run scoreboard players set @e[tag=boss16_lomia,tag=body] motion 0
