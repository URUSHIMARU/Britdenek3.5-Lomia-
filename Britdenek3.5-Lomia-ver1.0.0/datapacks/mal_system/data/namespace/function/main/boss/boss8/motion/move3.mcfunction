...
execute if entity @e[tag=boss8,tag=body,scores={motion=2..10}] as @e[tag=body1,limit=1,tag=boss8] at @s run teleport @s ~ ~ ~ ~ ~20
execute if entity @e[tag=boss8,tag=body,scores={motion=2..10}] as @e[tag=head,limit=1,tag=boss8] at @s run teleport @s ~ ~ ~ ~ ~10

execute if entity @e[tag=boss8,tag=body,scores={motion=2..10}] as @e[tag=body1,limit=1,tag=boss8] at @s run teleport @s ~ ~ ~ ~ ~-1
execute if entity @e[tag=boss8,tag=body,scores={motion=2..10}] as @e[tag=left_arm,limit=1,tag=boss8] at @s run teleport @s ~ ~ ~ ~5 ~-3
execute if entity @e[tag=boss8,tag=body,scores={motion=2..10}] as @e[tag=right_arm,limit=1,tag=boss8] at @s run teleport @s ~ ~ ~ ~-5 ~-3
execute if entity @e[tag=boss8,tag=body,scores={motion=2..10}] as @e[tag=body2,limit=1,tag=boss8] at @s run teleport @s ~ ~ ~ ~ ~3

execute if entity @e[tag=boss8,tag=body,scores={motion=10}] as @e[tag=body,tag=boss8] at @s run particle minecraft:splash ~ ~ ~ 2 2 2 1 1000 force
execute if entity @e[tag=boss8,tag=body,scores={motion=10}] as @e[tag=body,tag=boss8] at @s run playsound minecraft:entity.dolphin.splash master @a ~ ~ ~ 2 1


execute if entity @e[tag=boss8,tag=body,scores={motion=15..},limit=1] run scoreboard players set @e[tag=boss8,tag=body] motion2 0
execute if entity @e[tag=boss8,tag=body,scores={motion=15..},limit=1] run scoreboard players set @e[tag=boss8,tag=body] bossmove 4

#execute if entity @e[tag=boss8,tag=body,scores={motion=25..},limit=1] run scoreboard players set @e[tag=boss8,tag=body] motion 0
