...
execute if entity @e[tag=boss12,tag=body,scores={motion=22..30}] as @e[tag=left_arm,limit=1,tag=boss12] at @s run teleport @s ~ ~ ~ ~-5 ~-14
execute if entity @e[tag=boss12,tag=body,scores={motion=22..30}] as @e[tag=right_arm,limit=1,tag=boss12] at @s run teleport @s ~ ~ ~ ~5 ~-14


execute if entity @e[tag=boss12,tag=body,scores={motion=22}] as @e[tag=head,limit=1,tag=boss12] at @s run playsound minecraft:entity.polar_bear.warning master @a ~ ~ ~ 2 0.8
...
execute as @e[tag=boss12,tag=body,scores={motion=85..,HP=150..},limit=1] at @s if entity @e[tag=boss12battle,distance=..7] run function namespace:main/boss/boss12/motion/random11
execute as @e[tag=boss12,tag=body,scores={motion=85..,HP=150..},limit=1] at @s unless entity @e[tag=boss12battle,distance=..7] run function namespace:main/boss/boss12/motion/random12
execute as @e[tag=boss12,tag=body,scores={motion=85..,HP=..149},limit=1] at @s if entity @e[tag=boss12battle,distance=..7] run function namespace:main/boss/boss12/motion/random21
execute as @e[tag=boss12,tag=body,scores={motion=85..,HP=..149},limit=1] at @s unless entity @e[tag=boss12battle,distance=..7] run function namespace:main/boss/boss12/motion/random22
