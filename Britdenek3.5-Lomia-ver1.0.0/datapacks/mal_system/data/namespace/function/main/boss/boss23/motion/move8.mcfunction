...
execute if entity @e[tag=boss23,tag=body,scores={motion=35..37}] as @e[tag=body,limit=1,tag=boss23] at @s run particle minecraft:cloud ^ ^1 ^2 0.5 0.5 0.5 0.1 10 force
execute if entity @e[tag=boss23,tag=body,scores={motion=35..37}] as @e[tag=body,limit=1,tag=boss23] at @s run playsound minecraft:item.crossbow.shoot master @a ^ ^ ^3 1.4
execute if entity @e[tag=boss23,tag=body,scores={motion=35..37}] as @e[tag=body,limit=1,tag=boss23] at @s positioned ^ ^2 ^1.2 run function namespace:main/entity_model/boss/boss23/boss23_bullet5
execute if entity @e[tag=boss23,tag=body,scores={motion=35..37}] as @e[tag=body,limit=1,tag=boss23] at @s positioned ^ ^2 ^1.2 run function namespace:main/entity_model/boss/boss23/boss23_bullet5
execute if entity @e[tag=boss23,tag=body,scores={motion=35..37}] as @e[tag=body,limit=1,tag=boss23] at @s positioned ^ ^2 ^1.2 run function namespace:main/entity_model/boss/boss23/boss23_bullet5
