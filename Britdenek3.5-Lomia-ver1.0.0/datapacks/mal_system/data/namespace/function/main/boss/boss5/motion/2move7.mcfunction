...
execute if entity @e[tag=boss5,tag=body,scores={motion=1}] as @e[tag=boss5battle,limit=1,sort=random] at @s run summon minecraft:armor_stand ~ ~ ~ {Tags:["boss5target2"],Invisible:1b,Marker:1b}
...
#ÉÇÅ[ÉVÉáÉì
execute if entity @e[tag=boss5,tag=body,scores={motion=1..25}] as @e[tag=boss5] at @s unless block ^ ^1 ^1 #namespace:airs_for_mob run tag @e[tag=boss5,tag=body,limit=1,tag=!lock] add lock
execute if entity @e[tag=boss5,tag=body,scores={motion=1..25}] as @e[tag=boss5,tag=body,limit=1,tag=!lock] at @s run teleport @s ~ ~ ~ facing entity @e[tag=boss5target2,limit=1,sort=nearest]
execute if entity @e[tag=boss5,tag=body,scores={motion=1..25}] as @e[tag=boss5,tag=body,limit=1,tag=!lock] at @s run teleport @s ~ ~ ~ ~ 0
execute if entity @e[tag=boss5,tag=body,scores={motion=1..25}] as @e[tag=boss5,tag=body,limit=1,tag=!lock] at @s run teleport @s ^ ^ ^0.2 

execute if entity @e[tag=boss5,tag=body,scores={motion=25}] run kill @e[tag=boss5target2]

scoreboard players set @e[tag=boss5,tag=body,scores={motion2=25..},limit=1] motion2 0

execute if entity @e[tag=boss5,tag=body,scores={motion=1..},limit=1] run tag @e[tag=body,limit=1,tag=boss5] remove lock
