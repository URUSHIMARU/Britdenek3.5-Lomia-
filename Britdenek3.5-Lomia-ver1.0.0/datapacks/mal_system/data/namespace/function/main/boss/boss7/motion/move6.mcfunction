...
execute if entity @e[tag=boss7,tag=body,scores={motion=2..5}] as @e[tag=left_leg,limit=1,tag=boss7] at @s run teleport @s ~ ~ ~ ~6 ~8
execute if entity @e[tag=boss7,tag=body,scores={motion=2..5}] as @e[tag=right_leg,limit=1,tag=boss7] at @s run teleport @s ~ ~ ~ ~9 ~-10
