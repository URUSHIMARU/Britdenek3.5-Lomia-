...
execute if entity @e[tag=boss7,tag=body,scores={motion=2..18}] as @e[tag=body,tag=boss7,limit=1,tag=!stop] at @s run teleport @s ^ ^ ^0.8
execute if entity @e[tag=boss7,tag=body,scores={motion=2..11}] as @e[tag=body,tag=boss7,limit=1] at @s run teleport @s ^ ^1.3 ^
...
execute if entity @e[tag=boss7,tag=body,scores={motion=14..16}] as @e[tag=right_leg,limit=1,tag=boss7] at @s run teleport @s ~ ~ ~ ~2 ~12
execute if entity @e[tag=boss7,tag=body,scores={motion=14..16}] as @e[tag=right_arm,limit=1,tag=boss7] at @s run teleport @s ~ ~ ~ ~ ~20
execute if entity @e[tag=boss7,tag=body,scores={motion=14..16}] as @e[tag=sword,limit=1,tag=boss7] at @s run teleport @s ~ ~ ~ ~ ~60
execute if entity @e[tag=boss7,tag=body,scores={motion=14..16}] as @e[tag=sword,limit=1,tag=boss7] at @s run particle minecraft:explosion ^ ^2 ^ 0 0 0 1 3 force
execute if entity @e[tag=boss7,tag=body,scores={motion=14..16}] as @e[tag=sword,limit=1,tag=boss7] at @s run particle minecraft:explosion ^ ^4 ^ 0 0 0 1 3 force

execute if entity @e[tag=boss7,tag=body,scores={motion=14..18}] as @e[tag=sword,limit=1,tag=boss7] at @s positioned ^ ^2 ^ as @e[tag=boss7battle,distance=..4] unless score @s player = @e[tag=boss7,tag=body,limit=1] player run scoreboard players set @s commandDamage 26
execute if entity @e[tag=boss7,tag=body,scores={motion=14..18}] as @e[tag=sword,limit=1,tag=boss7] at @s positioned ^ ^4 ^ as @e[tag=boss7battle,distance=..4] unless score @s player = @e[tag=boss7,tag=body,limit=1] player run scoreboard players set @s commandDamage 26
execute if entity @e[tag=boss7,tag=body,scores={motion=14..18}] as @e[tag=sword,limit=1,tag=boss7] at @s positioned ^ ^6 ^ as @e[tag=boss7battle,distance=..4] unless score @s player = @e[tag=boss7,tag=body,limit=1] player run scoreboard players set @s commandDamage 26


execute if entity @e[tag=boss7,tag=body,scores={motion=18}] as @e[tag=sword,limit=1,tag=boss7] at @s run playsound minecraft:entity.lightning_bolt.impact master @a ^ ^ ^2 2 0.8
execute if entity @e[tag=boss7,tag=body,scores={motion=18}] as @e[tag=sword,limit=1,tag=boss7] at @s run particle minecraft:explosion_emitter ^ ^3 ^ 1 0 1 1 5 force
execute if entity @e[tag=boss7,tag=body,scores={motion=18}] as @e[tag=sword,limit=1,tag=boss7] at @s run particle minecraft:block{block_state:"minecraft:dirt"} ^ ^3 ^ 1 0.3 1 1 30 force
execute if entity @e[tag=boss7,tag=body,scores={motion=20}] as @e[tag=sword,limit=1,tag=boss7] at @s run particle minecraft:block{block_state:"minecraft:dirt"} ^ ^2 ^ 1 0.3 1 1 30 force
execute if entity @e[tag=boss7,tag=body,scores={motion=20}] as @e[tag=sword,limit=1,tag=boss7] at @s run particle minecraft:block{block_state:"minecraft:dirt"} ^ ^4 ^ 1 0.3 1 1 30 force

execute as @e[tag=boss7,tag=body,scores={motion=50..},limit=1] run function namespace:main/boss/boss7/motion/random3

#execute if entity @e[tag=boss7,tag=body,scores={motion=50..},limit=1] run scoreboard players set @e[tag=boss7,tag=body] motion 0
