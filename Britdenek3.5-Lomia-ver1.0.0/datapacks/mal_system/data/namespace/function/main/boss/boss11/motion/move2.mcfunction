...
execute if entity @e[tag=boss11,tag=body,scores={motion=22..30}] as @e[tag=body2,limit=1,tag=boss11] at @s run teleport @s ~ ~ ~ ~ ~-1
execute if entity @e[tag=boss11,tag=body,scores={motion=22..30}] as @e[tag=left_arm,limit=1,tag=boss11] at @s run teleport @s ~ ~ ~ ~-5 ~-14
execute if entity @e[tag=boss11,tag=body,scores={motion=22..30}] as @e[tag=right_arm,limit=1,tag=boss11] at @s run teleport @s ~ ~ ~ ~5 ~-14


execute if entity @e[tag=boss11,tag=body,scores={motion=22}] as @e[tag=head,limit=1,tag=boss11] at @s run playsound minecraft:entity.polar_bear.warning master @a ~ ~ ~ 2 0.8


execute if entity @e[tag=boss11,tag=body,scores={motion=85..},limit=1] run scoreboard players set @e[tag=boss11,tag=body] motion2 0
execute as @e[tag=boss11,tag=body,scores={motion=85..,HP=150..},limit=1] at @s if entity @e[tag=boss11battle,distance=..7] run function namespace:main/boss/boss11/motion/random11
execute as @e[tag=boss11,tag=body,scores={motion=85..,HP=150..},limit=1] at @s unless entity @e[tag=boss11battle,distance=..7] run function namespace:main/boss/boss11/motion/random12
execute as @e[tag=boss11,tag=body,scores={motion=85..,HP=..149},limit=1] at @s if entity @e[tag=boss11battle,distance=..7] run function namespace:main/boss/boss11/motion/random21
execute as @e[tag=boss11,tag=body,scores={motion=85..,HP=..149},limit=1] at @s unless entity @e[tag=boss11battle,distance=..7] run function namespace:main/boss/boss11/motion/random22

#execute if entity @e[tag=boss11,tag=body,scores={motion=85..},limit=1] run scoreboard players set @e[tag=boss11,tag=body] motion 0
