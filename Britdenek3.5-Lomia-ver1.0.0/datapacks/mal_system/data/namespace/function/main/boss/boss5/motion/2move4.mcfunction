...
execute if entity @e[tag=boss5,tag=body,scores={motion=61}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~40
execute if entity @e[tag=boss5,tag=body,scores={motion=62}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~35
execute if entity @e[tag=boss5,tag=body,scores={motion=63}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~30
execute if entity @e[tag=boss5,tag=body,scores={motion=64}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~25
execute if entity @e[tag=boss5,tag=body,scores={motion=65}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~20
execute if entity @e[tag=boss5,tag=body,scores={motion=66}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~15
execute if entity @e[tag=boss5,tag=body,scores={motion=67}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~10
execute if entity @e[tag=boss5,tag=body,scores={motion=68}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~5
execute if entity @e[tag=boss5,tag=body,scores={motion=69}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~0
execute if entity @e[tag=boss5,tag=body,scores={motion=70}] as @e[tag=boss5,tag=head] at @s run teleport @e[tag=head2,limit=1,tag=boss5] ^ ^-0.2 ^0.9 ~ ~-5
