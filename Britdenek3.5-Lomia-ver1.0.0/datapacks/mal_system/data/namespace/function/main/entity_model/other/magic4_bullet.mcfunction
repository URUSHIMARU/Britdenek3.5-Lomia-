...
execute store result storage bullet health double 0.12 run scoreboard players get @s magicAttackBase
...
data merge entity @e[tag=entity_first,limit=1,sort=nearest,distance=..1] {Offers:{},Tags:["magic4_bullet","bullet"]}
