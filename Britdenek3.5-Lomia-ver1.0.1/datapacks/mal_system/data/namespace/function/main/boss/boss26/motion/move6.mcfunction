...
execute if entity @e[tag=boss26,tag=body,scores={motion=2..25}] as @e[tag=boss26,tag=body] at @s run particle minecraft:firework ~ ~1 ~ 0.5 0.5 0.5 1 1 force
...
execute if entity @e[tag=boss26,tag=body,scores={motion=30..32}] as @e[tag=boss26,tag=body] at @s run execute if block ^ ^1 ^3 #namespace:airs_for_mob if block ^-2 ^1 ^ #namespace:airs_for_mob run teleport @s ^-2 ^ ^
execute if entity @e[tag=boss26,tag=body,scores={motion=33..35}] as @e[tag=boss26,tag=body] at @s run execute if block ^ ^1 ^3 #namespace:airs_for_mob if block ^2 ^1 ^ #namespace:airs_for_mob run teleport @s ^2 ^ ^
execute if entity @e[tag=boss26,tag=body,scores={motion=36..38}] as @e[tag=boss26,tag=body] at @s run execute if block ^ ^1 ^3 #namespace:airs_for_mob if block ^-2 ^1 ^ #namespace:airs_for_mob run teleport @s ^-2 ^ ^
execute if entity @e[tag=boss26,tag=body,scores={motion=39..41}] as @e[tag=boss26,tag=body] at @s run execute if block ^ ^1 ^3 #namespace:airs_for_mob if block ^2 ^1 ^ #namespace:airs_for_mob run teleport @s ^2 ^ ^
execute if entity @e[tag=boss26,tag=body,scores={motion=42..45}] as @e[tag=boss26,tag=body] at @s run execute if block ^ ^1 ^3 #namespace:airs_for_mob if block ^-2 ^1 ^ #namespace:airs_for_mob run teleport @s ^-2 ^ ^
...
execute if entity @e[tag=boss26,tag=body,scores={motion=80..},limit=1] run scoreboard players remove @e[tag=body,tag=boss26] bossskill5 10
