...
execute as @s at @s run loot spawn ~ ~ ~ loot namespace:random/random8
...
execute as @s at @s if entity @e[tag=boss23,tag=body,scores={HP=201..}] if entity @e[nbt={Item:{count:3,components:{"minecraft:custom_data":{random:1}}}},type=item,distance=..0.1] run scoreboard players set @s bossmove 4
execute as @s at @s if entity @e[tag=boss23,tag=body,scores={HP=..200}] if entity @e[nbt={Item:{count:3,components:{"minecraft:custom_data":{random:1}}}},type=item,distance=..0.1] run scoreboard players set @s bossmove 5
...
execute as @s at @s if entity @e[nbt={Item:{count:8,components:{"minecraft:custom_data":{random:1}}}},type=item,distance=..0.1] run scoreboard players set @s bossmove 10
