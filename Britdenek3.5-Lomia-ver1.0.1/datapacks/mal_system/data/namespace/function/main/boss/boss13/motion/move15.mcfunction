...
execute if entity @e[tag=boss13,tag=body,scores={motion=20..26}] as @e[tag=left_arm,limit=1,tag=boss13] at @s run teleport @s ^0.1 ^0.1 ^0.1 ~1 ~
execute if entity @e[tag=boss13,tag=body,scores={motion=20..26}] as @e[tag=right_arm,limit=1,tag=boss13] at @s run teleport @s ^-0.1 ^0.1 ^0.1 ~-1 ~

execute if entity @e[tag=boss13,tag=body,scores={motion=50}] as @e[tag=left_arm,limit=1,tag=boss13] at @s run particle minecraft:witch ~ ~1 ~ 1 1 1 1 500 force
execute if entity @e[tag=boss13,tag=body,scores={motion=50}] as @e[tag=right_arm,limit=1,tag=boss13] at @s run particle minecraft:witch ~ ~1 ~ 1 1 1 1 500 force
execute if entity @e[tag=boss13,tag=body,scores={motion=50}] as @e[tag=body,limit=1,tag=boss13] at @s run playsound minecraft:entity.evoker.cast_spell master @a ~ ~ ~ 2 1
execute if entity @e[tag=boss13,tag=body,scores={motion=50}] as @e[tag=body,limit=1,tag=boss13] at @s run summon minecraft:armor_stand ~ ~ ~ {Tags:["boss13_attack","boss13_rance4","boss13_rance"],Marker:1b,Invisible:1b}
