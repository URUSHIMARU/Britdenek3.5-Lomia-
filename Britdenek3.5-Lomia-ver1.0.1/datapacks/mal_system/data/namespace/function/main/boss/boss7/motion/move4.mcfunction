...
execute if entity @e[tag=boss7,tag=body,scores={motion=2..18}] as @e[tag=body,tag=boss7,limit=1,tag=!stop] at @s run teleport @s ^ ^ ^-0.7
...
execute if entity @e[tag=boss7,tag=body,scores={motion=2..5}] as @e[tag=body1,limit=1,tag=boss7] at @s run teleport @s ~ ~ ~ ~ ~-2
