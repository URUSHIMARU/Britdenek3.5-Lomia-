...
execute as @e[tag=boss16_lomia,tag=body,limit=1,scores={motion=10..16}] at @s if block ^ ^0.5 ^-2 #namespace:airs_for_mob run teleport @s ^ ^ ^-0.8
...
execute as @e[tag=boss16_lomia,tag=body,scores={motion=20..},limit=1] at @s run function namespace:main/boss/boss16_lomia/motion/random1
