#à íuèÓïÒï€ë∂
execute as @e[tag=boss3,tag=body] at @s store result score @s motion2 run data get entity @s Pos[1] 1.0
...
execute if entity @e[tag=boss3,tag=body,scores={motion=22..22},limit=1] as @e[tag=boss3,tag=body2] at @s run playsound minecraft:entity.polar_bear.death master @a ~ ~ ~ 3 0.9


#ñﬂÇ∑
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body] at @s run teleport @s ~ ~ ~ ~ 0
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body] at @s run teleport @e[tag=boss3,limit=1,tag=body2] ^ ^0.8 ^ ~ ~
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body2] at @s run teleport @e[tag=boss3,limit=1,tag=leg1] ^-1 ^ ^0.3 ~ ~
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body2] at @s run teleport @e[tag=boss3,limit=1,tag=leg2] ^1 ^ ^0.3 ~ ~

execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body2] at @s run teleport @e[tag=boss3,limit=1,tag=body1] ^ ^ ^1.5 ~ ~

execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body1] at @s run teleport @e[tag=boss3,limit=1,tag=leg3] ^-1.4 ^ ^1.3 ~5 ~
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body1] at @s run teleport @e[tag=boss3,limit=1,tag=leg4] ^1.4 ^ ^1.3 ~-5 ~
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body1] at @s run teleport @e[tag=boss3,limit=1,tag=head1] ^ ^ ^3 ~ ~

execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body1] at @s run teleport @e[tag=boss3,limit=1,tag=wing1] ^1.3 ^1 ^1.8 ~-10 ~-70
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=body1] at @s run teleport @e[tag=boss3,limit=1,tag=wing2] ^-1.3 ^1 ^1.8 ~10 ~-70

execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=head1] at @s run teleport @e[tag=boss3,limit=1,tag=head2] ^ ^-0.2 ^0.7 ~ ~-10
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=head1] at @s run playsound minecraft:entity.firework_rocket.twinkle master @a ~ ~ ~ 3 1.8
execute if entity @e[tag=boss3,tag=body,scores={motion=50},limit=1] as @e[tag=boss3,tag=head1] at @s run scoreboard players set @e[tag=boss3] bossskill1 250
...
execute if entity @e[tag=boss3,tag=body,scores={motion=61..},limit=1] run scoreboard players set @e[tag=boss3,tag=body] bossmove 3
execute if entity @e[tag=boss3,tag=body,scores={motion=61..},limit=1] run scoreboard players set @e[tag=boss3,tag=body] motion 0
