...
execute if entity @e[tag=boss12,tag=body,scores={motion=1}] as @e[tag=boss12,tag=body] at @s run teleport @s ~ ~ ~ ~180 0
...
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] run scoreboard players add @e[tag=boss12,tag=body,scores={motion2=0..},limit=1] motion2 1
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=2..3}] as @e[tag=left_arm,limit=1,tag=boss12] at @s run teleport @s ~ ~ ~ ~10 ~50
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=2..3}] as @e[tag=right_arm,limit=1,tag=boss12] at @s run teleport @s ~ ~ ~ ~-10 ~50
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=4..5}] as @e[tag=left_arm,limit=1,tag=boss12] at @s run teleport @s ~ ~ ~ ~-10 ~-50
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=4..5}] as @e[tag=right_arm,limit=1,tag=boss12] at @s run teleport @s ~ ~ ~ ~10 ~-50

execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s run summon silverfish ~ ~ ~ {NoAI:1b,Tags:["bullet","enemy","boss12_attack","boss12_attack1"],ArmorDropChances:[-100f,-100f,-100f,-100f],NoGravity:1b,Health:5,DeathLootTable:"namespace:item/other/none",NoAI:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2147483647,show_particles:0b}],DeathTime:19,Silent:1b}
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s run summon silverfish ~ ~ ~ {NoAI:1b,Tags:["bullet","enemy","boss12_attack","boss12_attack1"],ArmorDropChances:[-100f,-100f,-100f,-100f],NoGravity:1b,Health:5,DeathLootTable:"namespace:item/other/none",NoAI:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2147483647,show_particles:0b}],DeathTime:19,Silent:1b}
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s run summon silverfish ~ ~ ~ {NoAI:1b,Tags:["bullet","enemy","boss12_attack","boss12_attack1"],ArmorDropChances:[-100f,-100f,-100f,-100f],NoGravity:1b,Health:5,DeathLootTable:"namespace:item/other/none",NoAI:1b,active_effects:[{id:"minecraft:invisibility",amplifier:0b,duration:2147483647,show_particles:0b}],DeathTime:19,Silent:1b}
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s run teleport @e[tag=boss12_attack1,distance=..2] ~ ~1 ~ ~-180 ~-10
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s as @e[tag=boss12_attack1,distance=..2,limit=2,sort=random] at @s run teleport @s ~ ~ ~ ~12 ~
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s as @e[tag=boss12_attack1,distance=..2,limit=2,sort=random] at @s run teleport @s ~ ~ ~ ~-12 ~
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s as @e[tag=boss12_attack1,distance=..2,limit=2,sort=random] at @s run teleport @s ~ ~ ~ ~22 ~
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s as @e[tag=boss12_attack1,distance=..2,limit=2,sort=random] at @s run teleport @s ~ ~ ~ ~-22 ~
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s as @e[tag=boss12_attack1,distance=..2,limit=2,sort=random] at @s run teleport @s ~ ~ ~ ~ ~-1
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=5}] as @e[tag=body,limit=1,tag=boss12] at @s as @e[tag=boss12_attack1,distance=..2,limit=2,sort=random] at @s run teleport @s ~ ~ ~ ~ ~-3

execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] run scoreboard players set @e[tag=boss12,tag=body,scores={motion2=5..},limit=1] motion2 1
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] if entity @e[tag=boss12,tag=body,scores={motion2=2}] as @e[tag=body,limit=1,tag=boss12] at @s run playsound minecraft:block.rooted_dirt.place master @a ~ ~ ~ 2 1.4
execute if entity @e[tag=boss12,tag=body,scores={motion=30..80}] as @e[tag=body,limit=1,tag=boss12] at @s run particle minecraft:block{block_state:"minecraft:netherrack"} ^ ^ ^-1 1.5 1.5 1.5 1 100 force
