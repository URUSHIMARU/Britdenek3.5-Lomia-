...
execute if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance21,sort=nearest,limit=1] ~ ~0.2 ~ ~ 0
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=30}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance22,sort=nearest,limit=1] ~ ~ ~ ~ ~
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=30}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance22,sort=nearest,limit=1] ~ ~0.2 ~ ~72 0
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=30}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance23,sort=nearest,limit=1] ~ ~ ~ ~ ~
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=30}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance23,sort=nearest,limit=1] ~ ~0.2 ~ ~-72 0
execute if entity @e[tag=boss20,tag=body,scores={motion=60..79}] as @e[tag=boss20_rance6,tag=boss20_first] at @s run teleport @e[tag=boss20_bomb,sort=nearest,limit=1] ^ ^ ^1
...
execute if entity @e[tag=boss20,tag=body,scores={motion=71..80}] as @e[tag=boss20,tag=head] at @s run teleport @s ~ ~ ~ ~6 ~
execute if entity @e[tag=boss20,tag=body,scores={motion=81..140}] as @e[tag=boss20,tag=head] at @s run teleport @s ~ ~ ~ ~-2 ~

execute if entity @e[tag=boss20,tag=body,scores={motion=71..150}] as @e[tag=boss20,tag=head] at @s run particle minecraft:soul ^ ^1.4 ^1.7 0.1 0.1 0.1 0.02 10 force
execute if entity @e[tag=boss20,tag=body,scores={motion=71..150}] as @e[tag=boss20,tag=head] at @s run scoreboard players set @s bossskill5 0
execute if entity @e[tag=boss20,tag=body,scores={motion=81..150}] as @e[tag=boss20,tag=head] at @s positioned ^ ^1.4 ^ run function namespace:main/boss/boss20/sub/beam
