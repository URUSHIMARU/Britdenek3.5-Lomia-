...
execute if entity @e[tag=boss22sub,tag=body,scores={motion=22..30}] as @e[tag=left_arm,limit=1,tag=boss22sub] at @s run teleport @s ~ ~ ~ ~-5 ~-14
execute if entity @e[tag=boss22sub,tag=body,scores={motion=22..30}] as @e[tag=right_arm,limit=1,tag=boss22sub] at @s run teleport @s ~ ~ ~ ~5 ~-14


execute if entity @e[tag=boss22sub,tag=body,scores={motion=22}] as @e[tag=head,limit=1,tag=boss22sub] at @s run playsound minecraft:entity.polar_bear.warning master @a ~ ~ ~ 2 0.8
...
execute as @e[tag=boss22sub,tag=body,scores={motion=85..,HP=150..},limit=1] at @s if entity @e[tag=boss22subbattle,distance=..7] run function namespace:main/boss/boss22sub/motion/random11
execute as @e[tag=boss22sub,tag=body,scores={motion=85..,HP=150..},limit=1] at @s unless entity @e[tag=boss22subbattle,distance=..7] run function namespace:main/boss/boss22sub/motion/random12
execute as @e[tag=boss22sub,tag=body,scores={motion=85..,HP=..149},limit=1] at @s if entity @e[tag=boss22subbattle,distance=..7] run function namespace:main/boss/boss22sub/motion/random21
execute as @e[tag=boss22sub,tag=body,scores={motion=85..,HP=..149},limit=1] at @s unless entity @e[tag=boss22subbattle,distance=..7] run function namespace:main/boss/boss22sub/motion/random22
