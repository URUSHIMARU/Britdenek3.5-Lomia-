...
execute if entity @e[tag=boss24_lomia,tag=body,scores={motion=17}] as @e[tag=boss24_lomia,tag=body] at @s positioned ^ ^ ^2 as @e[tag=boss24_lomiabattle,distance=..4] unless score @s player = @e[tag=boss24_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 13
...
execute as @e[tag=boss24_lomia,tag=body,scores={motion=40..},limit=1] at @s run function namespace:main/boss/boss24_lomia/motion/random1
