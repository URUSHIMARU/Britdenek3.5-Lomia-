kill @e[tag=npc24_dummy,tag=lomia]
...
data merge entity @e[tag=mob_first,limit=1,sort=nearest,distance=..1] {CustomName:{"translate":"system.talk.lomia.npc24.name"},Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,Silent:1b,Tags:["Immortal","lomia","npc","npc24_dummy"]}
