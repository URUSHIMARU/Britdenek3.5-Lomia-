...
#本チャン実装で座標入れ必須
execute as @e[tag=boss9,tag=body] at @s at @e[distance=..70,tag=!boss9] if score @e[distance=..0.1,limit=1,tag=!boss9,sort=nearest] player < @s player run tag @e[distance=..0.1,limit=1,tag=!bullet,tag=!boss9,sort=nearest] add boss9battle
execute as @e[tag=boss9,tag=body] at @s at @e[distance=..70,tag=!boss9] if score @e[distance=..0.1,limit=1,tag=!boss9,sort=nearest] player > @s player run tag @e[distance=..0.1,limit=1,tag=!bullet,tag=!boss9,sort=nearest] add boss9battle
