...
execute as @e[tag=boss1002,tag=body] at @s at @e[distance=..70,tag=!boss1002] if score @e[distance=..0.1,limit=1,tag=!boss1002,sort=nearest] player < @s player run tag @e[distance=..0.1,limit=1,tag=!bullet,tag=!boss1002,sort=nearest] add boss1002battle
execute as @e[tag=boss1002,tag=body] at @s at @e[distance=..70,tag=!boss1002] if score @e[distance=..0.1,limit=1,tag=!boss1002,sort=nearest] player > @s player run tag @e[distance=..0.1,limit=1,tag=!bullet,tag=!boss1002,sort=nearest] add boss1002battle
