...
execute if entity @e[tag=boss3,tag=body,scores={motion=101..},limit=1] run scoreboard players set @e[tag=boss3,tag=body] bossmove 1
execute if entity @e[tag=boss3,tag=body,scores={motion=101..},limit=1] run scoreboard players set @e[tag=boss3,tag=body] motion 0
