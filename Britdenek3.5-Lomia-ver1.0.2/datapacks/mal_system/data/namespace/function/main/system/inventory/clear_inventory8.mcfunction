...
execute if score @s result matches ..0 run item replace entity @s player.cursor from entity @s inventory.8
execute if score @s result matches ..0 run loot replace entity @s inventory.8 loot namespace:item/inventory/empty_money_8
