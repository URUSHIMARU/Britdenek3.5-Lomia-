...
execute as @e[tag=boss24,tag=body1] at @s run teleport @e[tag=arm1,limit=1,tag=boss24] ^-0.35 ^-0.05 ^-0.03 ~ ~90
execute as @e[tag=boss24,tag=body1] at @s run teleport @e[tag=arm2,limit=1,tag=boss24] ^0.35 ^-0.05 ^-0.03 ~ ~90
...
scoreboard players set @e[tag=body,tag=boss24] motion 0
