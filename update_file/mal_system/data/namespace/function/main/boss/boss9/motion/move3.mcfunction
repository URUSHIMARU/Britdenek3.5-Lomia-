...
execute if entity @e[tag=boss9,tag=body,scores={motion=2}] as @e[tag=right_arm,limit=1,tag=boss9] at @s run function namespace:main/entity_model/boss/boss9/boss9_left_arm2
execute if entity @e[tag=boss9,tag=body,scores={motion=20}] run item replace entity @e[tag=boss9,tag=left_arm2] armor.head with minecraft:white_stained_glass[minecraft:custom_model_data={floats:[1075]}]
...
execute if entity @e[tag=boss9,tag=body,scores={motion=52..55}] as @e[tag=body,tag=boss9] at @s if block ^ ^ ^1 #namespace:airs_for_mob if block ^ ^ ^2 #namespace:airs_for_mob if block ^ ^ ^3 #namespace:airs_for_mob run teleport @s ^ ^ ^3
execute if entity @e[tag=boss9,tag=body,scores={motion=52..55}] as @e[tag=body,tag=boss9] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 1 1 1 1 10 force
execute if entity @e[tag=boss9,tag=body,scores={motion=52..55}] as @e[tag=body,tag=boss9] at @s run particle minecraft:soul_fire_flame ~ ~ ~ 1 1 1 0.8 100 force
execute if entity @e[tag=boss9,tag=body,scores={motion=52..55}] as @e[tag=boss9,tag=body] at @s as @e[tag=boss9battle,distance=..6] unless score @s player = @e[tag=boss9,tag=body,limit=1] player run scoreboard players set @s commandDamage 14
...
execute if entity @e[tag=boss9,tag=body,scores={motion=55..},limit=1] as @e[tag=left_arm2,tag=boss9] at @s run particle minecraft:explosion ^ ^1 ^1 1 1 1 1 10 force
execute if entity @e[tag=boss9,tag=body,scores={motion=55..},limit=1] as @e[tag=left_arm2,tag=boss9] at @s run particle minecraft:explosion ^ ^1 ^3 1 1 1 1 10 force
execute if entity @e[tag=boss9,tag=body,scores={motion=55..},limit=1] as @e[tag=left_arm2,tag=boss9] at @s run particle minecraft:explosion ^ ^1 ^5 1 1 1 1 10 force

execute if entity @e[tag=boss9,tag=body,scores={motion=55..},limit=1] run tp @e[tag=left_arm2,tag=boss9] ~ ~-200 ~
execute if entity @e[tag=boss9,tag=body,scores={motion=55..},limit=1] run kill @e[tag=left_arm2,tag=boss9]
