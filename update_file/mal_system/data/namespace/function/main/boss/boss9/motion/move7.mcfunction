...
execute if entity @e[tag=boss9,tag=body,scores={motion=52..60}] as @e[tag=body,tag=boss9] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 1 1 1 1 10 force
