...
execute if score ��Փx difficulty matches 2.. if entity @e[tag=boss12,tag=body,scores={motion=50..70}] as @e[tag=body1,limit=1,tag=boss12] at @s positioned ^ ^1 ^3 as @e[tag=boss12battle,distance=..8] unless score @s player = @e[tag=boss12,tag=body,limit=1] player run effect give @s minecraft:slowness 6 2
