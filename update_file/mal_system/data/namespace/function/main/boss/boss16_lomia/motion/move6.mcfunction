...
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=30..32}] as @e[tag=boss16_lomia,tag=body] at @s if block ^ ^0.5 ^2 #namespace:airs_for_mob run teleport @s ^ ^ ^2
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=30..32}] as @e[tag=boss16_lomia,tag=body] at @s positioned ^ ^-0.4 ^2 as @e[tag=boss16_lomiabattle,distance=..3] unless score @s player = @e[tag=boss16_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 15
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=30..32}] as @e[tag=boss16_lomia,tag=body] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~1 ~ 1 1 1 1 100 force
...
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=41..42}] as @e[tag=boss16_lomia,tag=body] at @s run teleport @e[tag=body,limit=1,tag=boss16_lomia] ~ ~0 ~ facing entity @e[tag=boss16_lomiabattle,limit=1]
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=41..42}] as @e[tag=boss16_lomia,tag=body] at @s run teleport @e[tag=body,limit=1,tag=boss16_lomia] ~ ~0 ~ ~ 0
...
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=50..51}] as @e[tag=boss16_lomia,tag=arm1] at @s run teleport @s ~ ~ ~ ~-30 ~10
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=50..51}] as @e[tag=boss16_lomia,tag=weapon] at @s run teleport @s ~ ~ ~ ~-30 ~-10

execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70}] as @e[tag=boss16_lomia,tag=arm1] at @s run playsound minecraft:item.trident.throw master @a ~ ~ ~ 2 1.6

execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=body] at @s if block ^ ^0.5 ^2 #namespace:airs_for_mob run teleport @s ^ ^ ^2
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=body] at @s positioned ^ ^-0.4 ^2 as @e[tag=boss16_lomiabattle,distance=..3] unless score @s player = @e[tag=boss16_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 15
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=body] at @s if block ^ ^0.5 ^2 #namespace:airs_for_mob run teleport @s ^ ^ ^2
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=body] at @s positioned ^ ^-0.4 ^2 as @e[tag=boss16_lomiabattle,distance=..3] unless score @s player = @e[tag=boss16_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 15
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=body] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~1 ~ 1 1 1 1 100 force
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=weapon] at @s run particle minecraft:sweep_attack ^ ^1.4 ^1 0.3 0.3 0.3 1 10 force
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=arm1] at @s run teleport @s ~ ~ ~ ~50 ~-10
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=70..72}] as @e[tag=boss16_lomia,tag=weapon] at @s run teleport @s ~ ~ ~ ~50 ~10
