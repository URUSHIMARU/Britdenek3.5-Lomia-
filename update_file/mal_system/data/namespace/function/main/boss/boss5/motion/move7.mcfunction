...
execute if entity @e[tag=boss5,tag=body,scores={motion=40}] as @e[tag=boss5,tag=body,limit=1] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 1 1 1 1 30 force
