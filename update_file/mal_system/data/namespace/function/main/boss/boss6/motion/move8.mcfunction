...
execute if entity @e[tag=boss6,tag=body,scores={motion=15..50}] as @e[tag=wing,limit=1,tag=boss6] at @s positioned ^ ^5 ^1 run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 0 0 0 1 1 force
...
execute if entity @e[tag=boss6,tag=body,scores={motion=60..68}] as @e[tag=boss6,sort=random,limit=1] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 2 2 2 1 5 force
