...
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run function namespace:main/entity_model/boss/boss20/boss20_bullet21
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run function namespace:main/entity_model/boss/boss20/boss20_bullet22
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run function namespace:main/entity_model/boss/boss20/boss20_bullet23
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance21,sort=nearest,limit=1] ~ ~ ~ ~ ~
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance21,sort=nearest,limit=1] ~ ~0.2 ~ ~-30 0
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance22,sort=nearest,limit=1] ~ ~ ~ ~ ~
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance22,sort=nearest,limit=1] ~ ~0.2 ~ ~-150 0
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance23,sort=nearest,limit=1] ~ ~ ~ ~ ~
execute if score #difficulty difficulty matches ..1 if entity @e[tag=boss20,tag=body,scores={motion=60}] as @e[tag=boss20,tag=body] at @s run teleport @e[tag=boss20_rance23,sort=nearest,limit=1] ~ ~0.2 ~ ~90 0
execute if entity @e[tag=boss20,tag=body,scores={motion=60..79}] as @e[tag=boss20_rance6,tag=boss20_first] at @s run teleport @e[tag=boss20_bomb,sort=nearest,limit=1] ^ ^ ^0.8
...
execute if entity @e[tag=boss20,tag=body,scores={motion=1..170}] as @e[tag=boss20] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 1 1 1 1 1 force
execute if entity @e[tag=boss20,tag=body,scores={motion=81..170}] as @e[tag=boss20] at @s run teleport @s ~ ~ ~ ~-1 ~

execute if entity @e[tag=boss20,tag=body,scores={motion=71..170}] as @e[tag=boss20,tag=head] at @s run particle minecraft:soul ^ ^1.4 ^1.7 0.1 0.1 0.1 0.02 10 force
execute if entity @e[tag=boss20,tag=body,scores={motion=71..170}] as @e[tag=boss20,tag=wing1] at @s run particle minecraft:soul ^ ^1.4 ^1.7 0.1 0.1 0.1 0.02 10 force
execute if entity @e[tag=boss20,tag=body,scores={motion=71..170}] as @e[tag=boss20,tag=wing2] at @s run particle minecraft:soul ^ ^1.4 ^1.7 0.1 0.1 0.1 0.02 10 force
...
execute if entity @e[tag=boss20,tag=body,scores={motion=81..170}] as @e[tag=boss20,tag=wing1] at @s run scoreboard players set @s bossskill5 0
execute if entity @e[tag=boss20,tag=body,scores={motion=81..170}] as @e[tag=boss20,tag=wing2] at @s run scoreboard players set @s bossskill5 0
...
execute if entity @e[tag=boss20,tag=body,scores={motion=81..170}] as @e[tag=boss20,tag=wing1] at @s rotated ~-30 ~ positioned ^ ^1.4 ^ run function namespace:main/boss/boss20/sub/beam
execute if entity @e[tag=boss20,tag=body,scores={motion=81..170}] as @e[tag=boss20,tag=wing2] at @s rotated ~30 ~ positioned ^ ^1.4 ^ run function namespace:main/boss/boss20/sub/beam
