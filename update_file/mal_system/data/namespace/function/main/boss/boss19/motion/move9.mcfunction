...
execute if entity @e[tag=boss19,tag=body,scores={motion=14..16}] as @e[tag=boss19,tag=weapon] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ^ ^3 ^3 2 2 2 1 5000 force
...
execute if entity @e[tag=boss19,tag=body,scores={motion=69..71}] as @e[tag=boss19,tag=weapon] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ^ ^3 ^3 2 2 2 1 5000 force
