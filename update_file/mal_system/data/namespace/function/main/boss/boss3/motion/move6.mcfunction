...
execute if entity @e[tag=boss3,tag=body,scores={motion=60..120},limit=1] as @e[tag=head1,tag=boss3] at @s positioned ^ ^5.5 ^0.1 run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 1 1 1 1 3 force
