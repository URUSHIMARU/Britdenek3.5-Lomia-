...
execute as @e[tag=boss26,tag=body1] at @s run teleport @e[tag=arm1,limit=1,tag=boss26] ^-0.25 ^0.6 ^0.05 ~-25 ~20
execute as @e[tag=boss26,tag=body1] at @s run teleport @e[tag=arm2,limit=1,tag=boss26] ^0.25 ^0.6 ^-0.03 ~0 ~-20
...
scoreboard players set @e[tag=body,tag=boss26] motion 0
