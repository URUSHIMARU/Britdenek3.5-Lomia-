...
particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~1 ~ 10 10 10 1 1000 force
...
execute as @e[distance=..30,tag=enemy] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~1 ~ 0.5 0.5 0.5 1 50 force
xp add @s -80 levels
