...
execute if score #difficulty difficulty matches 2.. if entity @e[tag=boss16_lomia,tag=body,scores={motion=30}] as @e[tag=boss16_lomia,tag=weapon] at @s positioned ^ ^-0.4 ^8 as @e[tag=boss16_lomiabattle,distance=..3] unless score @s player = @e[tag=boss16_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 14
execute if score #difficulty difficulty matches 2.. if entity @e[tag=boss16_lomia,tag=body,scores={motion=30}] as @e[tag=boss16_lomia,tag=weapon] at @s positioned ^ ^-0.4 ^10 as @e[tag=boss16_lomiabattle,distance=..3] unless score @s player = @e[tag=boss16_lomia,tag=body,limit=1] player run scoreboard players set @s commandDamage 14
...
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=50..},limit=1] run scoreboard players set @e[tag=boss16_lomia,tag=body] bossmove 3

execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=50..},limit=1] run scoreboard players set @e[tag=boss16_lomia,tag=body] motion 0
