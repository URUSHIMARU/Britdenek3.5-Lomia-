...
execute if entity @e[tag=boss18,tag=body,scores={motion=21}] as @e[tag=boss18,tag=head1] at @s run playsound minecraft:entity.wither.death master @a ~ ~ ~ 1.2 0.8
...
execute as @e[tag=boss18,tag=body,scores={motion=110..},limit=1] at @s run function namespace:main/boss/boss18/motion/random1
