...
execute if entity @e[tag=boss28,tag=body,scores={motion=40}] as @e[tag=boss28,tag=weapon] at @s run playsound minecraft:block.note_block.chime master @a ~ ~ ~ 2 1.65
execute if entity @e[tag=boss28,tag=body,scores={motion=40..42}] as @e[tag=boss28,tag=weapon] at @s run playsound minecraft:block.note_block.chime master @a ~ ~ ~ 2 1.75
execute if entity @e[tag=boss28,tag=body,scores={motion=41..42}] as @e[tag=boss28,tag=weapon] at @s run playsound minecraft:block.note_block.chime master @a ~ ~ ~ 2 1.95
execute if entity @e[tag=boss28,tag=body,scores={motion=42..42}] as @e[tag=boss28,tag=weapon] at @s run playsound minecraft:block.note_block.chime master @a ~ ~ ~ 2 1.8

execute if entity @e[tag=boss28,tag=body,scores={motion=43}] as @e[tag=boss28,tag=body] at @s run function namespace:main/boss/boss28/motion/random2
...
execute if entity @e[tag=boss28,tag=body,scores={motion=43}] as @e[tag=boss28,tag=body] at @s run playsound minecraft:entity.wither.spawn master @a ~ ~ ~ 1 2

execute if score #difficulty difficulty matches 2.. as @e[tag=boss28,tag=body,scores={motion=43,bossskill1=1}] at @s run particle minecraft:flame ~ ~1 ~ 0 0 0 0.5 100 force
execute if score #difficulty difficulty matches 2.. as @e[tag=boss28,tag=body,scores={motion=43,bossskill1=3}] at @s run particle minecraft:flame ~ ~1 ~ 0 0 0 0.5 100 force
