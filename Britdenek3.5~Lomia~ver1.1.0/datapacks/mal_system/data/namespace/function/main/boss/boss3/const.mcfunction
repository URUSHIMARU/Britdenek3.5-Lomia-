...
#光のオーラ
execute as @e[tag=boss3,scores={bossskill1=1..}] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 1 1 1 1 1 force
...
execute as @e[tag=boss3_crys,tag=boss3glow] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~2 ~ 0 1 0 1 1 force
