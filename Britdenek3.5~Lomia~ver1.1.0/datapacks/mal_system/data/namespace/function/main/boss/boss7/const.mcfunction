...
execute as @e[tag=boss7,tag=body] at @s at @e[distance=..70,tag=!boss7] if score @e[distance=..0.1,limit=1,tag=!boss7,sort=nearest] player < @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss7,sort=nearest] add boss7battle
execute as @e[tag=boss7,tag=body] at @s at @e[distance=..70,tag=!boss7] if score @e[distance=..0.1,limit=1,tag=!boss7,sort=nearest] player > @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss7,sort=nearest] add boss7battle
