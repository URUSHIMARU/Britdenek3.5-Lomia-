...
execute as @e[tag=boss22sub,tag=body1] at @s run teleport @e[tag=body2,limit=1,tag=boss22sub] ^ ^1.7 ^0.5 ~ ~20
...
execute as @e[tag=boss22sub,tag=body2] at @s run teleport @e[tag=left_arm,limit=1,tag=boss22sub] ^1.7 ^1.2 ^0.5 ~ ~-20
execute as @e[tag=boss22sub,tag=body2] at @s run teleport @e[tag=right_arm,limit=1,tag=boss22sub] ^-1.7 ^1.2 ^0.5 ~ ~-20
