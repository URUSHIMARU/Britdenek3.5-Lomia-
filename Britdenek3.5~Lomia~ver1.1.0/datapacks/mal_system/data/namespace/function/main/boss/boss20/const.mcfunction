...
#本チャン実装で座標入れ必須
execute as @e[tag=boss20,tag=body] at @s at @e[distance=..70,tag=!boss20] if score @e[distance=..0.1,limit=1,tag=!boss20,sort=nearest] player < @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss20,sort=nearest] add boss20battle
execute as @e[tag=boss20,tag=body] at @s at @e[distance=..70,tag=!boss20] if score @e[distance=..0.1,limit=1,tag=!boss20,sort=nearest] player > @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss20,sort=nearest] add boss20battle
...
#デスポーン
execute as @e[tag=boss20,tag=body] at @s unless entity @e[tag=boss20battle,distance=..70] run function namespace:main/boss/boss20/despawn
