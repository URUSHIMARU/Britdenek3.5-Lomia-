...
execute if entity @e[tag=boss10,tag=body,scores={motion2=4}] as @e[tag=body,limit=1,tag=boss10] at @s run particle block{block_state:"minecraft:dirt"} ~ ~ ~ 2 0.1 2 1 100 force
...
execute if entity @e[tag=boss10,tag=body,scores={motion2=8}] as @e[tag=body,limit=1,tag=boss10] at @s run particle block{block_state:"minecraft:dirt"} ~ ~ ~ 2 0.1 2 1 100 force
