...
scoreboard players add @e[tag=boss18,tag=body,scores={motion2=0..,motion=21..136},limit=1] motion2 1
scoreboard players set @e[tag=boss18,tag=body,scores={motion=1},limit=1] motion2 0
scoreboard players set @e[tag=boss18,tag=body,scores={motion=137..},limit=1] motion2 0
execute if entity @e[tag=boss18,tag=body,scores={motion=21..130}] as @e[tag=boss18,tag=head1] at @s run playsound minecraft:entity.shulker.hurt master @a ~ ~ ~ 2 0.8
...
scoreboard players add @e[tag=boss18,tag=body,scores={motion=21..136},limit=1] bossskill3 1
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3

execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18,tag=head1] at @s run teleport @e[tag=boss18_attack3,tag=boss18_first] ^ ^2 ^6 ~ ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~5 ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~10 ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~15 ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-5 ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-10 ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-15 ~
execute if entity @e[tag=boss18,tag=body,scores={bossskill3=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~5
...
scoreboard players set @e[tag=boss18,tag=body,scores={bossskill3=6..},limit=1] bossskill3 0
scoreboard players set @e[tag=boss18,tag=body,scores={motion=137..},limit=1] bossskill3 0
scoreboard players set @e[tag=boss18,tag=body,scores={motion=1},limit=1] bossskill3 0
...
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head1] at @s run teleport @s ~ ~ ~ ~ ~-1.5
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head2] at @s run teleport @s ~ ~ ~ ~ ~-3
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head3] at @s run teleport @s ~ ~ ~ ~3 ~
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head4] at @s run teleport @s ~ ~ ~ ~-3 ~
...
execute as @e[tag=boss18,tag=body,limit=1,scores={motion=21..140}] at @s if block ^ ^0.5 ^2 #namespace:airs_for_mob run teleport @s ^ ^ ^0.1
...
execute as @e[tag=boss18,tag=body,limit=1,scores={motion=21..140}] at @s positioned ^ ^ ^15 unless entity @e[tag=boss18battle,distance=..10] run execute as @e[tag=boss18] at @s run teleport @s ~ ~ ~ ~-0.8 ~
