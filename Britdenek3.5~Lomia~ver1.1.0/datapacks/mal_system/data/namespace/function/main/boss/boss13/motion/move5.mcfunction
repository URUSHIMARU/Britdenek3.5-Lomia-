...
execute if entity @e[tag=boss13,tag=body,scores={motion2=1,motion=2..55}] as @e[tag=body1,limit=1,tag=boss13] at @s run playsound minecraft:entity.ravager.step master @a ~ ~ ~ 0.6 1.1
execute if entity @e[tag=boss13,tag=body,scores={motion2=14,motion=2..55}] as @e[tag=body1,limit=1,tag=boss13] at @s run playsound minecraft:entity.ravager.step master @a ~ ~ ~ 0.6 1.1
...
execute as @e[tag=boss13] at @s unless block ^ ^0.6 ^1 #namespace:airs_for_mob unless block ^ ^0.6 ^2 #namespace:airs_for_mob run tag @e[tag=boss13,tag=body] add bossStop
execute if entity @e[tag=boss13,tag=body] as @e[tag=boss13,tag=body,tag=bossStop] at @s if block ^ ^1 ^1 #namespace:airs_for_mob if block ^ ^1 ^2 #namespace:airs_for_mob run teleport @s ^ ^1 ^
...
execute as @e[tag=boss13,tag=body,tag=bossStop] at @s run scoreboard players set @s motion 112
execute as @e[tag=boss13,tag=body] at @s if entity @e[tag=boss13battle,distance=..7] run scoreboard players set @s motion 112

execute as @e[tag=boss13,tag=body,scores={motion=56..},limit=1] at @s run function namespace:main/boss/boss13/motion/random1



#execute if entity @e[tag=boss13,tag=body,scores={motion=56..},limit=1] run scoreboard players set @e[tag=boss13,tag=body] motion 0
