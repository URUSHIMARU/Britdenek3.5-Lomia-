...
#本チャン実装で座標入れ必須
execute as @e[tag=boss26,tag=body] at @s at @e[distance=..70,tag=!boss26] if score @e[distance=..0.1,limit=1,tag=!boss26,sort=nearest] player < @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss26,sort=nearest] add boss26battle
execute as @e[tag=boss26,tag=body] at @s at @e[distance=..70,tag=!boss26] if score @e[distance=..0.1,limit=1,tag=!boss26,sort=nearest] player > @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss26,sort=nearest] add boss26battle

execute as @e[tag=boss26,tag=body] at @s at @e[distance=..70,tag=!boss26] if score @e[distance=..0.1,limit=1,tag=!boss26,sort=nearest] player < @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=bullet,tag=!boss26,sort=nearest] add boss26battleBullet
execute as @e[tag=boss26,tag=body] at @s at @e[distance=..70,tag=!boss26] if score @e[distance=..0.1,limit=1,tag=!boss26,sort=nearest] player > @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=bullet,tag=!boss26,sort=nearest] add boss26battleBullet
...
execute if entity @e[tag=body,tag=boss26,scores={bossskill5=3..}] as @e[tag=body,tag=boss26,scores={bossskill5=3..}] at @s positioned ^ ^ ^1 if entity @e[tag=boss26battleBullet,tag=bullet,distance=..6] as @e[tag=boss26battleBullet,tag=bullet,distance=..6] at @s run playsound minecraft:entity.player.attack.sweep master @a ~ ~ ~ 1 1.2
execute if entity @e[tag=body,tag=boss26,scores={bossskill5=3..}] as @e[tag=body,tag=boss26,scores={bossskill5=3..}] at @s positioned ^ ^ ^1 if entity @e[tag=boss26battleBullet,tag=bullet,distance=..6] as @e[tag=boss26battleBullet,tag=bullet,distance=..6] at @s run particle minecraft:sweep_attack ~ ~ ~ 1 1 1 1 30 force
execute if entity @e[tag=body,tag=boss26,scores={bossskill5=3..}] as @e[tag=body,tag=boss26,scores={bossskill5=3..}] at @s positioned ^ ^ ^1 if entity @e[tag=boss26battleBullet,tag=bullet,distance=..6] if entity @e[tag=boss26battleBullet,tag=bullet,distance=..6] run scoreboard players remove @s bossskill5 3
execute if entity @e[tag=body,tag=boss26,scores={bossskill5=3..}] as @e[tag=body,tag=boss26,scores={bossskill5=3..}] at @s positioned ^ ^ ^1 if entity @e[tag=boss26battle,tag=bullet,distance=..6] if entity @e[tag=boss26battleBullet,tag=bullet,distance=..6] run execute as @a[distance=..30,advancements={namespace:skill/skill_root=true,namespace:skill/normal/skill33=true,namespace:skill/normal/skill38=false}] run advancement grant @s only namespace:skill/normal/skill38
execute if entity @e[tag=body,tag=boss26,scores={bossskill5=3..}] as @e[tag=body,tag=boss26,scores={bossskill5=3..}] at @s positioned ^ ^ ^1 if entity @e[tag=boss26battleBullet,tag=bullet,distance=..6] as @e[tag=boss26battleBullet,tag=bullet,distance=..6] at @s run kill @s
