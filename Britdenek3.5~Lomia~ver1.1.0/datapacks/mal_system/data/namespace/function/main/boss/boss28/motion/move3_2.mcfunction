...
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^ ^ ^-1 #namespace:airs_for_mob if block ^ ^1 ^-1 #namespace:airs_for_mob as @e[tag=boss28] if block ^ ^2 ^-1 #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^ ^ ^-1
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^ ^ ^-1 #namespace:airs_for_mob if block ^ ^1 ^-1 #namespace:airs_for_mob as @e[tag=boss28] if block ^ ^2 ^-1 #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^ ^ ^-1
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^ ^ ^-1 #namespace:airs_for_mob if block ^ ^1 ^-1 #namespace:airs_for_mob as @e[tag=boss28] if block ^ ^2 ^-1 #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^ ^ ^-1
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^ ^ ^-1 #namespace:airs_for_mob if block ^ ^1 ^-1 #namespace:airs_for_mob as @e[tag=boss28] if block ^ ^2 ^-1 #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^ ^ ^-1
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^ ^ ^-1 #namespace:airs_for_mob if block ^ ^1 ^-1 #namespace:airs_for_mob as @e[tag=boss28] if block ^ ^2 ^-1 #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^ ^ ^-1
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^1 ^ ^ #namespace:airs_for_mob if block ^1 ^1 ^ #namespace:airs_for_mob as @e[tag=boss28] if block ^1 ^2 ^ #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^1 ^ ^
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^1 ^ ^ #namespace:airs_for_mob if block ^1 ^1 ^ #namespace:airs_for_mob as @e[tag=boss28] if block ^1 ^2 ^ #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^1 ^ ^
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^1 ^ ^ #namespace:airs_for_mob if block ^1 ^1 ^ #namespace:airs_for_mob as @e[tag=boss28] if block ^1 ^2 ^ #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^1 ^ ^
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^1 ^ ^ #namespace:airs_for_mob if block ^1 ^1 ^ #namespace:airs_for_mob as @e[tag=boss28] if block ^1 ^2 ^ #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^1 ^ ^
execute if entity @e[tag=boss28,tag=body,scores={motion=60}] as @e[tag=boss28,tag=body] at @s if block ^1 ^ ^ #namespace:airs_for_mob if block ^1 ^1 ^ #namespace:airs_for_mob as @e[tag=boss28] if block ^1 ^2 ^ #namespace:airs_for_mob as @e[tag=boss28] as @e[tag=boss28] at @s run teleport @s ^1 ^ ^
...
execute if entity @e[tag=boss28,tag=body,scores={motion=40..60}] as @e[tag=boss28,tag=body] at @s positioned ^-50 ^ ^15 if entity @e[tag=boss28battle,distance=..52] at @s positioned ^50 ^ ^15 if entity @e[tag=boss28battle,distance=..52] run tag @e[tag=boss28,tag=body] add boss28Stop

execute if entity @e[tag=boss28,tag=body,scores={motion=61}] run tag @e[tag=boss28,tag=body] remove boss28Stop
execute if entity @e[tag=boss28,tag=body,scores={motion=70..},limit=1] run scoreboard players remove @e[tag=boss28,tag=body] bossskill2 100
