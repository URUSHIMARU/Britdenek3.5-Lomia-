...
execute if entity @e[tag=boss28,tag=body,scores={motion=55..60}] at @e[tag=boss28] run particle flame ~ ~1 ~ 0.5 0.5 0.5 0.1 4 force
execute if entity @e[tag=boss28,tag=body,scores={motion=55..60}] at @e[tag=boss28] run particle flame ~ ~2 ~ 0.5 0.5 0.5 0.15 4 force
execute if entity @e[tag=boss28,tag=body,scores={motion=55..60}] at @e[tag=boss28] run particle flame ~ ~3 ~ 0.5 0.5 0.5 0.2 4 force
...
execute if entity @e[tag=boss28,tag=body,scores={motion=70..},limit=1] run scoreboard players set @e[tag=boss28,tag=body] bossmove 31
