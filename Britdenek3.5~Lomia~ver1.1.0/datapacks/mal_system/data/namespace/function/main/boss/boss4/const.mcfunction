...
execute as @e[tag=boss4,tag=body] at @s at @e[distance=..70,tag=!boss4] if score @e[distance=..0.1,limit=1,tag=!boss4,sort=nearest] player < @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss4,sort=nearest] add boss4battle
execute as @e[tag=boss4,tag=body] at @s at @e[distance=..70,tag=!boss4] if score @e[distance=..0.1,limit=1,tag=!boss4,sort=nearest] player > @s player run tag @e[tag=!notBattle,distance=..0.1,limit=1,tag=!bullet,tag=!boss4,sort=nearest] add boss4battle
