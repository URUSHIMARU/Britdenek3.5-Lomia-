...
execute if entity @e[tag=boss18,tag=body,scores={motion=80}] as @e[tag=boss18,tag=body] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ^ ^2 ^13 2 2 2 0.7 50 force
