...
execute if entity @e[tag=boss5,tag=body,scores={motion=1}] as @e[tag=boss5,limit=1,tag=body] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~ ~ 2 2 2 1 10 force
