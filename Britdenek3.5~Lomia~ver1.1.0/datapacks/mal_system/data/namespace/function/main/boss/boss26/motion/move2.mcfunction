...
execute if entity @e[tag=boss26,tag=body,scores={motion=3..20}] as @e[tag=arm1,limit=1,tag=boss26] at @s run teleport @s ~ ~ ~ ~ ~-0.3
execute if entity @e[tag=boss26,tag=body,scores={motion=3..20}] as @e[tag=arm2,limit=1,tag=boss26] at @s run teleport @s ~ ~ ~ ~ ~0.3


execute if entity @e[tag=boss26,tag=body,scores={motion=60..},limit=1] run scoreboard players add @e[tag=body,tag=boss26] bossskill5 10


#execute if entity @e[tag=boss26,tag=body,scores={motion=60..},limit=1] run scoreboard players set @e[tag=boss26,tag=body] bossmove 5
execute as @e[tag=boss26,tag=body,scores={motion=60..},limit=1] at @s run function namespace:main/boss/boss26/motion/random1

#execute if entity @e[tag=boss26,tag=body,scores={motion=60..},limit=1] run scoreboard players set @e[tag=boss26,tag=body] motion 0
