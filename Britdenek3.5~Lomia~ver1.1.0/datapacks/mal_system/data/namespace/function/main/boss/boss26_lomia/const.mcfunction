...
#本チャン実装で座標入れ必須
execute as @e[tag=boss26_lomia,tag=body] at @s at @e[distance=..70,tag=!boss26_lomia] if score @e[distance=..0.1,limit=1,tag=!boss26_lomia,sort=nearest] lomia < @s lomia run tag @e[distance=..0.1,limit=1,tag=!boss26_lomia,sort=nearest] add boss26_lomiabattle
execute as @e[tag=boss26_lomia,tag=body] at @s at @e[distance=..70,tag=!boss26_lomia] if score @e[distance=..0.1,limit=1,tag=!boss26_lomia,sort=nearest] lomia > @s lomia run tag @e[distance=..0.1,limit=1,tag=!boss26_lomia,sort=nearest] add boss26_lomiabattle
