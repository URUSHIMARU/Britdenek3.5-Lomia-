...
execute if entity @e[tag=boss9,tag=body,scores={motion=28..31}] as @e[tag=body,limit=1,tag=boss9] at @s run particle minecraft:flash{color:[1.0,1.0,1.0,0]} ~ ~4 ~ 2 2 2 1 100 force
