...
execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=85..},limit=1] run scoreboard players set @e[tag=boss16_lomia,tag=body] bossmove 3
#execute as @e[tag=boss16_lomia,tag=body,scores={motion=85..},limit=1] at @s run function namespace:main/boss/boss16_lomia/motion/random1

execute if entity @e[tag=boss16_lomia,tag=body,scores={motion=85..},limit=1] run scoreboard players set @e[tag=boss16_lomia,tag=body] motion 0
