...
execute if entity @e[tag=boss18,tag=body,scores={motion=21..30}] as @e[tag=boss18,tag=head1] at @s run teleport @s ~ ~ ~ ~ ~-10
execute if entity @e[tag=boss18,tag=body,scores={motion=21..30}] as @e[tag=boss18,tag=head2] at @s run teleport @s ~ ~ ~ ~ ~-4
execute if entity @e[tag=boss18,tag=body,scores={motion=21..30}] as @e[tag=boss18,tag=head3] at @s run teleport @s ~ ~ ~ ~-5 ~-4
execute if entity @e[tag=boss18,tag=body,scores={motion=21..30}] as @e[tag=boss18,tag=head4] at @s run teleport @s ~ ~ ~ ~5 ~-4
...
scoreboard players add @e[tag=boss18,tag=body,scores={motion2=0..,motion=26..151},limit=1] motion2 1

execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18,tag=head1] at @s run function namespace:main/entity_model/boss/boss18/boss18_bullet3
...
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18,tag=head1] at @s run teleport @e[tag=boss18_attack3,tag=boss18_first] ^ ^ ^6 ~ ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=2] at @s run teleport @s ~ ~ ~ ~180 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=2] at @s run teleport @s ~ ~ ~ ~90 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=2] at @s run teleport @s ~ ~ ~ ~-90 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~5 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~15 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~20 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~25 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-5 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-15 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-20 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~-25 ~
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~5
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~10
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~15
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~20
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~25
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~30
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~35
execute if entity @e[tag=boss18,tag=body,scores={motion2=3}] as @e[tag=boss18_attack3,tag=boss18_first,sort=random,limit=3] at @s run teleport @s ~ ~ ~ ~ ~35

scoreboard players set @e[tag=boss18,tag=body,scores={motion2=6..},limit=1] motion2 0
scoreboard players set @e[tag=boss18,tag=body,scores={motion2=1..,motion=151},limit=1] motion2 0



tag @e[tag=boss18_first] remove boss18_first

execute if entity @e[tag=boss18,tag=body,scores={motion=21}] as @e[tag=boss18,tag=head1] at @s run playsound minecraft:entity.wither.death master @a ~ ~ ~ 2 0.8
execute if entity @e[tag=boss18,tag=body,scores={motion=26..160}] as @e[tag=boss18,tag=head1] at @s run particle dust{color:[255,1.0,255.0],scale:1} ^ ^-1 ^4 0.5 0.5 0.5 1 10 force

execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=body2] at @s run teleport @s ~ ~ ~ ~ ~1.5
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head1] at @s run teleport @s ~ ~ ~ ~ ~10
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head2] at @s run teleport @s ~ ~ ~ ~ ~4
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head3] at @s run teleport @s ~ ~ ~ ~5 ~4
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=head4] at @s run teleport @s ~ ~ ~ ~-5 ~4

execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=arm11] at @s run teleport @s ~ ~ ~ ~4 ~-2
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=arm21] at @s run teleport @s ~ ~ ~ ~-2 ~-2
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=arm12] at @s run teleport @s ~ ~ ~ ~2 ~
execute if entity @e[tag=boss18,tag=body,scores={motion=151..160}] as @e[tag=boss18,tag=arm22] at @s run teleport @s ~ ~ ~ ~-2 ~
