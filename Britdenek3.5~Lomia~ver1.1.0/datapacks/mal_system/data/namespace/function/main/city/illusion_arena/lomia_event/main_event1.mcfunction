...
execute if score #event_time event matches 930 run particle minecraft:flash{color:[1.0,1.0,1.0,0]} -426 59 915 0 1 2 1 100 force
...
execute if score #event_time event matches 2620 run gamerule advance_time true
