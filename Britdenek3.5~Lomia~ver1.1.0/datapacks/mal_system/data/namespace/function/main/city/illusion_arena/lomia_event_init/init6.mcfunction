...
function namespace:main/city/illusion_arena/set_book/book6
kill @e[tag=npc]
scoreboard players set #main_storyline event 6
#オートマトン・ファーマー
...
#アルバス(牧師)
execute positioned -421 93 943 run function namespace:main/entity_model/npc/lomia/npc20
execute as @e[tag=npc20] at @s run teleport @s ~ ~ ~ 0 0
#旅人1
execute unless block -432 94 884 minecraft:lantern positioned -405 92 926 run function namespace:main/entity_model/npc/lomia/npc23
execute as @e[tag=npc23] at @s run teleport @s ~ ~ ~ 180 0
#旅人2
execute positioned -392 92 909 run function namespace:main/entity_model/npc/lomia/npc24
execute as @e[tag=npc24] at @s run teleport @s ~ ~ ~ 0 0
...
execute as @e[tag=npc17_dummy] at @s run teleport @s ~ ~ ~ 180 0
#アスラン
execute positioned -338 105 956 run function namespace:main/entity_model/npc/lomia/dummy/npc19
execute as @e[tag=npc19_dummy] at @s run teleport @s ~ ~ ~ 180 0
#ピサロ
...
#旅人1
execute positioned -311 101 951 run function namespace:main/entity_model/npc/lomia/dummy/npc23
execute as @e[tag=npc23_dummy] at @s run teleport @s ~ ~ ~ 180 0
#旅人2
execute positioned -341 101 951 run function namespace:main/entity_model/npc/lomia/dummy/npc24
execute as @e[tag=npc24_dummy] at @s run teleport @s ~ ~ ~ 180 0
#オートマトン・マスク
execute positioned -377 92 894 run function namespace:main/entity_model/npc/lomia/npc25
execute as @e[tag=npc25] at @s run teleport @s ~ ~ ~ 90 0
