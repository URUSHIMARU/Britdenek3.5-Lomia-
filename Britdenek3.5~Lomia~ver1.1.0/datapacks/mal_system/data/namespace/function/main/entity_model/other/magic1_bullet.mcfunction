...
data merge storage minecraft:bullet {entity:"wandering_trader",health:5,id:110}
...
data merge entity @e[tag=entity_first,limit=1,sort=nearest,distance=..1] {Offers:{},Tags:["magic1_bullet","bullet"]}
